...
public class RequestContextConstants {
    ...
    public static final String REQUEST_INFO_FIELD_NAME_PASCAL_CASE = "RequestHeader";
    public static final String REQUEST_INFO_FIELD_NAME_CAMEL_CASE = "requestHeader";
